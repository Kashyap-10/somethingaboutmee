                ...
                {EXPERIENCES.map((exprience, index) => (
                    <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
                        <motion.div
                            ...
                            <p className="mb-2 text-sm text-neutral-400">{exprience.year}</p>
                        </motion.div>
                        <motion.div
                            whileInView={{ opacity: 1, x: 0 }}
                            initial={{ opacity: 0, x: 100 }}
                            ...
                            <h6 className="mb-2 font-semibold">{exprience.role} - <span className="text-sm text-purple-100">{exprience.company}</span></h6>
